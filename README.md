...
## Step 1:
Create a virtual environment and run the following: <br>
...
```python3 1_train_new_moe.py model=tinybert dataset=hotpotqa testing=hotpotqa model.adapters.use_adapters=True model.adapters.num_experts=6 model.init.specialized_mode=sbmoe_all``` <br><br>
